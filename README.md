...
This app grabs the headlines from the Guardian newspaper API and displays them on the page with the relevant picture. Clicking on the headline will bring you to the original article from the web page.
