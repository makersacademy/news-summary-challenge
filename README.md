...
I have so far achieved the four primary User Stories and added some styling. Due to the Guardian's 12 hit limit on their free API, I also built a simple [news server](https://github.com/sophiegilder/Mock-news-API-server) with Express to host static content during development before connecting to the Guardian's servers. This meant I was able to see how the page looked as many times as I liked in addition to mocking the API calls in my tests.
