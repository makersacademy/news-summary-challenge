...
URL request anatomy: curl -O "http://news-summary-api.herokuapp.com/guardian?apiRequestUrl=http://content.guardianapis.com/politics/blog/2014/feb/17/alex-salmond-speech-first-minister-scottish-independence-eu-currency-live?show-fields=body"

curl all sections:

curl -O "http://news-summary-api.herokuapp.com/guardian?apiRequestUrl=http://content.guardianapis.com/sections"

curl news section:

curl -O "http://news-summary-api.herokuapp.com/guardian?apiRequestUrl=http://content.guardianapis.com/sections?q=uk-news"

curl uk news section:

curl -O "http://news-summary-api.herokuapp.com/guardian?apiRequestUrl=http://content.guardianapis.com/uk-news"

ACTUALLY curl news section:
curl -O "http://news-summary-api.herokuapp.com/guardian?apiRequestUrl=http://content.guardianapis.com/news"
...
![us1](/images/news-summary-challengeUS1.png)
- on load, page requests top headline JSON from API
- controller routes JSON to model
- model formats JSON as HTML list in view
