...
$ git clone https://github.com/sunali1/news-summary-challenge.git
...
Its a single page web app. The code in frontend JavaScript, CSS and HTML.  
No Ruby or backend JavaScript used. No libraries or frameworks used.

Own testing framework written.
