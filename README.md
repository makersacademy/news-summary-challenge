...
```
--> Display a list of headlines on page load
...
```
--> Display full story of clicked story title
...
```
--> Display picture along with summary / full story views
...
## MVP
* Site connects to an API
* Page shows top ten headlines
* Clicking on a link in bottom 5 opens summary view
* Clicking on a link in top 5 opens full view

## Nice To Haves
* Images with the summary / full views
* Search query
* Site adaptable to mobile version
* Animations
