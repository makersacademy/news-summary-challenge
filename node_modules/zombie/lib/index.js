...
var _require3 = require('./dom/impl');

var idlUtils = _require3.idlUtils;
...
var Browser = (function (_EventEmitter) {
  ...
  _createClass(Browser, [{
    ...
    key: 'focus',
    value: function focus(selector, callback) {
    ...
    key: 'fill',
    value: function fill(selector, value, callback) {
    ...
    key: '_setCheckbox',
    value: function _setCheckbox(selector, value, callback) {
      var field = this.field(selector);
    ...
    key: 'check',
    value: function check(selector, callback) {
    ...
    key: 'uncheck',
    value: function uncheck(selector, callback) {
    ...
    key: 'choose',
    value: function choose(selector, callback) {
    ...
    key: 'select',
    value: function select(selector, value, callback) {
    ...
    key: 'selectOption',
    value: function selectOption(selector, callback) {
    ...
    key: 'unselect',
    value: function unselect(selector, value, callback) {
      var option = this._findOption(selector, value);
    ...
    key: 'unselectOption',
    value: function unselectOption(selector, callback) {
      var option = this.query(selector);
      if (option && option.selected) {
        var select = this.xpath('./ancestor::select', option).iterateNext();
    ...
    key: 'attach',
    value: function attach(selector, filename, callback) {
      var field = this.field(selector);
    ...
    value: function pressButton(selector, callback) {
      ...
      button.focus();
      var impl = idlUtils.implForWrapper(button);
