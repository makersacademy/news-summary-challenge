...
var HTMLFrameElementImpl = _require.HTMLFrameElementImpl;
var HTMLElementImpl = _require.HTMLElementImpl;
...
function loadFrame(frameImpl) {
  ...
  function onload() {
    ...
    var parentDocument = frameImpl._ownerDocument;
    var loadEventImpl = parentDocument.createEvent('HTMLEvents');
    loadEventImpl.initEvent('load', false, false);

    var frame = idlUtils.wrapperForImpl(frameImpl);
    var loadEvent = idlUtils.wrapperForImpl(loadEventImpl);
