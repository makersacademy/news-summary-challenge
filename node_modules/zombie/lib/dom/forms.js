...
var domSymbolTree = _require.domSymbolTree;
var HTMLInputElementImpl = _require.HTMLInputElementImpl;
...
DOM.HTMLFormElement.prototype._dispatchSubmitEvent = function (button) {
  ...
  var inputElementImpl = idlUtils.implForWrapper(event._button);
  var bodyElementImpl = domSymbolTree.parent(domSymbolTree.parent(inputElementImpl));
  var dispatchResult = this.dispatchEvent(event);
...
DOM.HTMLInputElement.prototype.click = function () {
  ...
  function click() {
    ...
    var labelElementImpl = domSymbolTree.parent(idlUtils.implForWrapper(input));
    var dispatchResult = input.dispatchEvent(clickEvent);
