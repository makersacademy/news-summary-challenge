...
request.onload = function() {
  ...
  for(i = 0; i < apidata.length; i++) {
    articlelist.save(apidata[i].webTitle, apidata[i].fields.body, apidata[i].webUrl, apidata[i].webPublicationDate, apidata[i].fields.thumbnail, apidata[i].fields.main);
  }
