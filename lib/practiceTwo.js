...
Headlines.prototype.allHeadlines = function () {
  for(var i in this.headlinesArray) {
    ...
    summaryButton.addEventListener('click', function() { headlines.showSummary() } );
    // summaryButton.setAttribute('class', 'paragraph_links')
    // summaryButton.setAttribute('string', `${this.headlinesArray[i].summary}`)
...
Headlines.prototype.showSummary = function () {
  console.log("testing show summary")
  for(var i in this.headlinesArray) {
...
Headlines.prototype.hideSummary = function () {}
