...
NewsManager.prototype = {
  ...
  displayArticles: function() {
    ...
    for (i = 0; i < 10; i++) {
      ...
      articleDiv.setAttribute('class', 'article-summary')
      newLine = document.createElement('br')
      articleDiv.appendChild(newsItems[i].displayImage())
      articleDiv.appendChild(newLine)
      articleDiv.appendChild(newsItems[i].displayLink(i))
