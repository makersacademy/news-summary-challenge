...
describe("NewView class", () => {
  ...
  it("loads articles titles to home page", () => {
    ...
    expect(document.querySelectorAll(".article-title")[1].innerText).toEqual("title2");
  });
  ...
  it("loads article images to home page", () => {
    ...
    expect(document.querySelectorAll(".article-image")[1].src).toEqual("http://localhost/src2");
  });
})