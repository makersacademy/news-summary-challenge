  ...
  Barracuda = {
    ...
    toEqual: function(b) {
      if (this.a === b || (this.a !== b && this.falsey === true)) {
        this.falsey = false;
        return console.log('%c passed the test', 'color: green; font-size: 14px;');
      }
      console.log(
    ...
    isArray: function() {
      if (typeof this.a === 'object' || (this.a !== 'object' && this.falsey === true)) {
        this.falsey = false;
        return console.log('%c passed the test', 'color: green; font-size: 14px;');
      }
      console.log(
    ...
    describe: function(message, fn) {
      console.log(`%c ${message}'s tests:`, 'font-weight: bold; font-size: 2em;');
    ...
    it: function(message, fn) {
      console.log(`%c Test -- ${message} -- Test`, 'font-style: italic; font-size: 1.2em');
      if (typeof fn === 'function') {
        fn.call();
      }
    },
