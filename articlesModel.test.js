...
describe('Articles Model', () => {
  it('sets an argument from the API and returns it', () => {
    ...
    model.setArticles(mockArticle);
    expect(model.getArticles()).toEqual(mockArticle)
  })
  ...
  it('sets an argument from the API and returns it', () => {
    ...
    model.setArticles([mockArticle1, mockArticle2]);
    expect(model.getArticles()).toEqual([mockArticle1, mockArticle2])
  })
})