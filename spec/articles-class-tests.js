...
describe('Article Class', () => {
    ...
    it('Takes in a JS object upon initiation', () => {
      let fakeArticleData = [{webPublicationDate: "Default", webTitle: "Default", webUrl: "Default", thumnail: "Default"}];
    ...
    it('formats the date of the article', () => {
      let fakeArticleData = [{webPublicationDate: "2020-07-29T12:00:48Z", webTitle: "Default", webUrl: "Default", thumnail: "Default"}];
      let articleClass = new ArticleClass(fakeArticleData);
