describe('returns html string of titles', function(){
  ...
  return assert.isTrue(allNews.putInElements(testData.response.results) === '<ul><li><div><a href="https://www.theguardian.com/football/live/2017/dec/09/west-ham-united-v-chelsea-premier-league-live">West Ham United 1-0 Chelsea: Premier League – as it happened</a><p><a id="0" href="#football/live/2017/dec/09/west-ham-united-v-chelsea-premier-league-live">View Summary</a></p></div></li><li><div><a href="https://www.theguardian.com/money/2017/dec/09/millennial-railcard-young-workers-rail-fares">Millennial railcard: a fare deal or quick fix that fails to deliver?</a><p><a id="1" href="#money/2017/dec/09/millennial-railcard-young-workers-rail-fares">View Summary</a></p></div></li></ul>')
});
...
var allNews = new AllNews()
allNews.makeRequest("http://192.168.43.91:8080/testdata.html", allNews.putInElementsRenderHTML)
setTimeout(function() {
