describe('viewHeadlines', function () {
  ...
  it("lists each headline from an array of stories", function () {
    ...
    expect(document.getElementById('headlines').innerHTML).toEqual(
      `<ul><li><a href="https://www.bbc.co.uk/news/health-54873105">Coronavirus cured</a></li><li><a href="https://www.bbc.co.uk/news/election-us-2020-54836636">Trump defeated</a></li></ul>`
    )
  })
})