...
(function() {
  runner.register(function testArticleInstanceOfArticle() {
    var article = new Article("football/live/2017/dec/10/liverpool-v-everton-premier-league-live", "Sport", "Liverpool v Everton: Premier League – live!", "test", "test-body");
  ...
  runner.register(function testBody() {
    var article = new Article("football/live/2017/dec/10/liverpool-v-everton-premier-league-live", "Sport", "Liverpool v Everton: Premier League – live!", "test", "test-body");
    return assert.returns(article.getBody(), "test-body");
  })
